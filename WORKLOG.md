...
**Not done**: The other Mac's running connector is not stopped by a take-over; that remains a manual `launchctl bootout` on that Mac. The Gumroad product remains a draft.
