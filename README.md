...
The standard build exposes 146 tools: Notes (32), Mail (32), Filesystem (18), Contacts (15), Reminders (11), Calendar (6), Messages (6), Capture (6), Utilities (7), Maps (6), Shortcuts (4), and Location (3). Surfaces start off except Maps and Utilities, so a fresh install advertises 13 tools until you enable more during onboarding or in Settings. The eighteen Filesystem tools additionally stay hidden until you share a folder, and six WeatherKit tools are excluded from every current build because their `WEATHERKIT_AVAILABLE` compilation condition is never set.
