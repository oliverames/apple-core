...
The standard build exposes 172 tools: Mail (37), Notes (32), Filesystem (20), Contacts (18), Reminders (14), Utilities (11), Maps (8), Messages (8), Calendar (7), Capture (7), Location (5), and Shortcuts (5). Surfaces start off except Maps and Utilities, so a fresh install advertises 19 tools until you enable more during onboarding or in Settings. The twenty Filesystem tools additionally stay hidden until you share a folder, and six WeatherKit tools are excluded from every current build because their `WEATHERKIT_AVAILABLE` compilation condition is never set.
