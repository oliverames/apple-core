...
The standard build exposes 186 tools: Mail (42), Notes (32), Filesystem (22), Contacts (19), Reminders (14), Utilities (12), Maps (9), Calendar (8), Messages (8), Capture (8), Location (6), and Shortcuts (6). Surfaces start off except Maps and Utilities, so a fresh install advertises 21 tools until you enable more during onboarding or in Settings. The twenty-two Filesystem tools additionally stay hidden until you share a folder, and six WeatherKit tools are excluded from every current build because their `WEATHERKIT_AVAILABLE` compilation condition is never set.
